...
This outlines how to propose a change to rollout. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("iancero/rollout", fork = TRUE)`.
...
Please note that the rollout project is released with a [Contributor
Code of Conduct](https://iancero.github.io/rollout/CODE_OF_CONDUCT.md).
