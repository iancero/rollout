...
Or, you can install the development version of `rollout` directly from
...
will have a slightly different number of units, reflecting real-world
differences in site sizes.
...
evaluation of multiple scenarios within the same simulation pipeline.
...
#>    <dbl> <chr>      <dbl> <fct>          <int>   <int>  <dbl>      <dbl>
...
replicates. This enables us to simulate multiple trials under the same
design to estimate power and evaluate bias efficiently.
...
#>       <int>  <dbl> <chr>      <dbl> <fct>          <int>   <int>  <dbl>
...
After fitting the models, we now extract key results and evaluate bias
and power for our intervention effect.
...
#>  1    0.2 (Inte…       10         0.333          0.110  0.45 -0.155       NA    
#>  2    0.2 chron…       10         0.333          0.110  0.45 NA           NA    
#>  3    0.2 condi…       10         0.333          0.110  0.45 NA            0.328
#>  4    0.2 sd__(…       10         0.333          0.110  0.45 NA           NA    
#>  5    0.2 sd__O…       10         0.333          0.110  0.45 NA           NA    
#>  6    0.5 (Inte…       10         0.333          0.110  0.45 -0.192       NA    
#>  7    0.5 chron…       10         0.333          0.110  0.45 NA           NA    
#>  8    0.5 condi…       10         0.333          0.110  0.45 NA            0.590
#>  9    0.5 sd__(…       10         0.333          0.110  0.45 NA           NA    
#> 10    0.5 sd__O…       10         0.333          0.110  0.45 NA           NA
```
