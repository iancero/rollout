...
Thanks for using rollout! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/iancero/rollout/issues/new).
...
requests](https://github.com/iancero/rollout/issues) to make sure the
