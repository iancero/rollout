...
Rollout is under development and therefore not yet available on CRAN. However, you can install the development version of rollout via GitHub.
...
Rollout's functions are designed guide you through each of these steps, which are described in more detail below.
